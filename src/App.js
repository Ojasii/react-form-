...
class FormComponent extends React.Component {
  constructor() {
    ...
    //Binding methods to the component instances.
  ...
  validatePhoneNumber() {
    ...
    if (value.trim() === "") phoneNumberError = "Phone Number is required";
      ...
      phoneNumberError = "Phone Number is not valid. Format: +CCXXXXXXXXXX";
  ...
  //This display the summary of the details submitted by the user.
  render() {
    return (
      <div className="main" >
        <h3>SignUp Form</h3>
        {this.state.isFormSubmitted ? (
          ...
          <div style={{ textAlign: "center" }}>
            <form onSubmit={this.handleSubmit} >
              ...
              <input
                type="text"
                placeholder="Phone Number (Format: +CCXXXXXXXXXX)"
                name="phoneNumber"
